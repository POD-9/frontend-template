...
const PaymentForm = () => {
    return (
        <div className=' p-6'>
    <WalletInteractionButton action={"import"} information={"payment"} />
        <div className="w-full mx-auto rounded-lg bg-white shadow-lg p-5 text-gray-700">
        <div className="mb-10">
            <h1 className="text-center font-bold text-xl uppercase">Choose payment method</h1>
        </div>
        <div className="mb-3 flex -mx-2">
            <div className="px-2">
                <label className="flex items-center cursor-pointer">
                    <input type="radio" className="form-radio h-5 w-5 text-indigo-500" name="type" id="type1" checked onChange={() => {}} />
    ...
    <WalletInteractionButton action={"share"} information={"payment"} />
</div>
    )
}
